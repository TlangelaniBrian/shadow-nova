<template>
  <div class="space-y-8">
    ...
    <div>
      ...
      <p class="text-gray-400 dark:text-gray-500 mt-1">Manage your account preferences</p>
    </div>
      ...
      <div class="space-y-4">
        <div>
          ...
          <input v-model="username" type="text"
            class="w-full px-4 py-2 border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100 rounded-xl focus:ring-2 focus:ring-purple-500 focus:border-transparent outline-none transition-all" />
        </div>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-3xl p-6 md:p-8 border border-gray-100 dark:border-gray-700 shadow-sm">
      <h3 class="text-lg font-bold text-gray-900 dark:text-gray-100 mb-6">Notification Preferences</h3>
      ...
      <div class="space-y-4">
        <label class="flex items-center justify-between cursor-pointer">
          ...
          <input v-model="emailNotifications" type="checkbox"
            class="w-5 h-5 text-purple-600 rounded border-gray-300 dark:border-gray-700 focus:ring-2 focus:ring-purple-500" />
        </label>

        <label class="flex items-center justify-between cursor-pointer">
          <span class="text-gray-700 dark:text-gray-300">Dark Mode</span>
          <input v-model="themeStore.isDarkMode" type="checkbox"
            class="w-5 h-5 text-purple-600 rounded border-gray-300 dark:border-gray-700 focus:ring-2 focus:ring-purple-500" />
        </label>
      </div>
    </div>
